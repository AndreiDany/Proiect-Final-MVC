...
<title>Adaugare produs culinar</title>
...
<!-- Adaugare produs -->
  <div class="w3-container w3-padding-64">
    ...
    <h1>Adaugare produs</h1><br>
    
    <form:form action="adaugareProdus.htm" method="post" modelAttribute="produsCulinarForm">
      ...
      <input type="Submit" value="Adaugare produs">
